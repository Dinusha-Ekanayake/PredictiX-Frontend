  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-50 dark:bg-slate-950">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -bottom-56 -right-56 h-225 w-225nded-full bg-white/70 blur-[160px] float-slow-3 dark:hidden" />
        ...
        <div className="hidden dark:block absolute -bottom-56 -right-56 h-225 w-225nded-full bg-white/5 blur-[180px] float-slow-3" />
